...
<div class="col-md-12" style="padding:0px;">
	<h3 class="col-md-12" style="padding-top:8px;padding-bottom:8px;text-align:left;font-size:x-large;font-weight:bold;background-color:#1d1a1a;color:#ffffff;"><img style="cursor:pointer;width:100px;height:30px;margin-right: 15px;" src="images/murdoch_logo.png">Self Peer Evaluation System</h3>
		...
		<div class="login-form">
			...
			<form id="form" action="" method="post">
				<div class="form-group">
					<input type="text" name="userid" class="form-control cInput" placeholder="Enter your email" required="required">
				</div>
				<div class="form-group">

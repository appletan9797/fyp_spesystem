												...
												while ($row_spe= $request_spe->fetch_assoc())
												{
													echo "<div class='row movedown'>";
														echo "<div id='".$row_spe['SPEID']."' class='cSPERecords col-md-12 col-xs-12' style='padding:0px;'><a class='spename'>SPE".$speCounter."</a>";
															echo "<img title='Edit SPE' class='cSPEHandler cEdit' src='images/edit.png'>";
															echo "<img title='Download Student List' class='cSPEHandler cDownload' src='images/download.png'>";
															echo "<img title='Edit Due Date' class='cSPEHandler cDueDate' src='images/calendar.png'>";
															echo "<img title='Delete SPE' class='cSPEHandler cDelete' src='images/delete.png'>";
														echo "</div>";
													echo "</div>";
													$speCounter++;
												}

<?php
	...
	$sql_selectspecounter= "SELECT * FROM spe WHERE UCID = '$ucid' AND UnitCode = '$unitcode' AND Visibility = 1";
	$request_specounter= $connection->query($sql_selectspecounter);
	$recordno = mysqli_num_rows($request_specounter);
	if ($recordno >= 2){
		echo 0;
	}
	else

...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/create_spe.css">
	...
	<!-- //google fonts -->
	<title>SPE Failed To Create</title>
</head>
<body>
<script type="text/javascript" src="JS/create_spe.js"></script>
	...
	<div class="col-md-12 col-xs-12" style="padding:0px;">
		...
		<div class="col-md-12 col-xs-12" style="background-color:#1d1a1a;">
			<div class="col-md-6 col-xs-6" style="padding-top:8px;padding-bottom:8px;text-align:left;font-size:x-large;font-weight:bold;color:#ffffff;">
				<div class="header"><img style="cursor:pointer;width:100px;height:30px;margin-right: 15px;" src="images/murdoch_logo.png"><span onclick="window.location.href='../login/index.php'">Self Peer Evaluation System</span></div>
			</div>
		...
		<h2 id="iSubmitted">There are more than 2 active SPE, please remove one if you wish to add SPE. </h2>
		</div>

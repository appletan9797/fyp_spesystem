<?php
	...
	$delete_spetemplate_question_sql = "DELETE FROM spe_templatedetail WHERE SPETemplateID= $spetemplateid";
	$delete_template_result = $connection->query($delete_spetemplate_question_sql);
